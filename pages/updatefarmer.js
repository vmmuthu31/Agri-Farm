...
const UpdateData = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const params = {
      ...
      UpdateExpression:
        "set manufacturerName = :a, manufacturerDetails = :b, city = :c, productName =:d, productPrice =:e, productCategory = :f, phoneNumber = :z, dateModified = :k",
      ExpressionAttributeValues: {
        ":a": event.target.manufacturerName.value,
        ":b": event.target.manufacturerDetails.value,
          ...
          <form onSubmit={handleSubmit} id="addData-form">
            ...
            <div className="form-group mb-6">
              ...
              <input
                ...
                defaultValue={data.manufacturerDetails}
              />
            </div>
            <div className="form-group mb-6">
              <label
